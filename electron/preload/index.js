...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  accounts: {
    ...
    checkDependencies: (id) => ipcRenderer.invoke('accounts:checkDependencies', id),
    getCapitalSummary: (capitalAccountId) => ipcRenderer.invoke('accounts:getCapitalSummary', capitalAccountId),
    listCapitalTransactions: (capitalAccountId) => ipcRenderer.invoke('accounts:listCapitalTransactions', capitalAccountId),
